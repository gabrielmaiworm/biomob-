...
class _MapaEstacionamentoWidgetState extends State<MapaEstacionamentoWidget> {
  ...
  BottomEstacionamentoWidget bottomEstacionamentoWidget =
      BottomEstacionamentoWidget();

  dynamic selectedEstacionamento;
  void setSelectedEstacionamento(dynamic estacionamento) =>
      setState(() => selectedEstacionamento = estacionamento);
  ...
  Future<List<FlutterFlowMarker>> getLatAndLong() async {
    String url = "http://177.70.102.109:3007/biomob-api/estacionamento/lista";
    ...
    for (final estacionamento in responseBody) {
      ...
      marker = FlutterFlowMarker(estacionamento['estacionamentoId'], latLng,
          () async {
    ...
    return Scaffold(
      ...
      body: GestureDetector(
        ...
        child: SlidingUpPanel(
          ...
          panel: BottomEstacionamentoWidget(
              estabelecimentoPlace: selectedEstacionamento),
